...
const name_count = document.getElementById('t-page_name');
...
name_count.textContent = localStorage.getItem('card_name');
...
function Basket(i, price){
    if(localStorage.getItem('basket_counter') === 0){
        ...
        Book(i, price)
        BasketCounter_Head(localStorage.getItem('counter'))
    }else{
